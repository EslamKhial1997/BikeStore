...
exports.createOne = (Model) =>
  expressAsyncHandler(async (req, res) => {
    const newPath = path.join(__dirname, 'F:\\NODEJAVASCRIPT\\BackBikeStore\\Services\\path_to_new_directory\\new_file_name.txt', 'new_file_name.txt');
    console.log(newPath);
    const result = await uploadImageToCloudinary(newPath, "123", "catagory-images")
