...
exports.createSubCategoryValidator = [
  ...
  body("name").isLength({ min: 2 }).withMessage("To Shoort Name ,createSubCategoryValidator"),
  body("name").isLength({ max: 32 }).withMessage("To Longer Name ,createSubCategoryValidator"),
  check("category").isMongoId().withMessage("Product Must be a Mongo ID ,createSubCategoryValidator"),
  MiddlewareValidator,
];
