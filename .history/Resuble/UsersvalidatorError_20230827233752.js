...
exports.UpdateUserPassword = [
  ...
  check("password")
    ...
    .custom(async (val, { req }) => {
      ...
      // var ciphertext = CryptoJS.AES.encrypt(JSON.stringify(user.password), process.env.ENCRYPT).toString();
      var bytes  = CryptoJS.AES.decrypt(user.password, process.env.ENCRYPT');
