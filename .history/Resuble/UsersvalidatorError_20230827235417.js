...
exports.UpdateUserPassword = [
  ...
  check("password")
    ...
    var encrypted = CryptoJS.AES.encrypt(req.body.currentPasword, process.env.ENCRYPT).toString();
    var decrypted = CryptoJS.AES.decrypt(req.body.currentPasword, process.env.ENCRYPT).toString();
